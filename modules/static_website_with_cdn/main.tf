...
resource "azurerm_storage_account_network_rules" "this" {
  count              = var.enable_storage_account_firewall ? 1 : 0
...
module "cdn" {
  ...
  csp_allowed_frame_sources  = var.csp_allowed_frame_sources
  csp_allowed_worker_sources = var.csp_allowed_worker_sources
